...
<code>𝝁<sub>NEG</sub>(𝝺<sub>1</sub>) = 0
<code>𝝁<sub>ZERO</sub>(𝝺<sub>1</sub>) = 0
<code>𝝁<sub>POS</sub>(𝝺<sub>1</sub>) = 0

<code>𝝁<sub>NEG</sub>(𝝺<sub>2</sub>) = 0
<code>𝝁<sub>ZERO</sub>(𝝺<sub>2</sub>) = 0
<code>𝝁<sub>POS</sub>(𝝺<sub>2</sub>) = 0

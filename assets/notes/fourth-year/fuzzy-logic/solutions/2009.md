...
IF Temperature is PLEASANT THEN Speed is MEDIUM
...
<code>𝝁<sub>COOL</sub>(x) = (15-x)/(15-10) if 10 ≤ x ≤ 15</code>  
<code>𝝁<sub>COLD</sub>(x) = 0 if x > 15</code>

<code>𝝁<sub>COOL</sub>(x) = (x-10)/(12.5-10) if 10 < x ≤ 15</code>  
<code>𝝁<sub>COOL</sub>(x) = (18-x)/(18-15) if 15 < x < 18</code>  

<code>𝝁<sub>PLEASANT</sub>(x) = (x-10)/(12.5-10) if 12.5 < x ≤ 14</code>
<code>𝝁<sub>PLEASANT</sub>(x) = 1 if 14 < x ≤ 22</code>  
<code>𝝁<sub>PLEASANT</sub>(x) = (18-x)/(18-15) if 22 < x < 25.5</code>  

<code>𝝁<sub>WARM</sub>(x) = 0 if x ≤ 2</code>  
<code>𝝁<sub>WARM</sub>(x) = 1-(8-x)/(8-2) if 2 < x < 8</code>  
<code>𝝁<sub>WARM</sub>(x) = 1 if x ≥ 8</code>

<code>𝝁<sub>HOT</sub>(x) = 1 if x ≤ 2</code>  
<code>𝝁<sub>HOT</sub>(x) = (8-x)/(8-2) if 2 < x < 8</code>  
<code>𝝁<sub>HOT</sub>(x) = 0 if x ≥ 8</code>
